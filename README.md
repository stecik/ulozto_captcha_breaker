...
- Images 175x70
- Dichromatic black and white images (pixels have only 2 values: 0 for black, 255 for white). There is a function in functions.ypnb which converts rgb images into black and white.
